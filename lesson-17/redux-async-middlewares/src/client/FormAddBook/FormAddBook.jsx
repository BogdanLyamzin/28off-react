    ...
    return (
        <form action="" onSubmit={handleSubmit}>
            <div className={styles.formGroup}>
                ...
                <input required name="title" onChange={handleChange} type="text" value={data.title} placeholder="Название книги" id={nameId} />
            </div>
            <div className={styles.formGroup}>
                <label htmlFor={authorId} className={styles.label}>Автор</label>
                <input required name="author" onChange={handleChange} type="text" value={data.author} placeholder="Автор книги" id={authorId} />
            </div>
